...
public class HoldingDataBean {
	...
	public HoldingDataBean(Integer holdingID, Date purchaseDate, String symbol, double quantity,
			BigDecimal purchasePrice, BigDecimal currentPrice, BigDecimal purchasePasis, BigDecimal marketValue,
			BigDecimal gain) {
