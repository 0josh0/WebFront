...
<%@ page
    import="java.util.Collection,java.util.Iterator,java.math.BigDecimal,org.iscas.util.*,org.iscas.databean.*,org.iscas.entity.*"
    session="true" isThreadSafe="true" isErrorPage="false"%>
<jsp:useBean id="results" scope="request" type="java.lang.String" />
<jsp:useBean id="accountData"
    type="org.iscas.entity.Account"
    scope="request" />
<jsp:useBean id="accountProfileData"
    type="org.iscas.entity.AccountProfile"
    scope="request" />
        ...
        <TR>
            ...
            <TABLE width="100%">
                <TBODY>
                    ...
                    <TR>
                        ...
                        ID:</A></TD>
                        <TD valign="bottom"><%=accountData.getProfileUserID()%></TD>
                        <TD valign="bottom"></TD>
                        <TD align="right" valign="bottom"><A href="docs/glossary.html">total
                        logouts: </A></TD>
            ...
            while (it.hasNext()) {
                if ((showAllOrders == false) && (count++ >= 5))
                    break;
                Orders orderData = (Orders) it.next();
                ...
                <TBODY>
                    <TR>
                        ...
                        <INPUT size="20" type="text" name="symbols"
                            value="s:01, s:02, s:03, s:04, s:05"></FORM>
                        </TD>
                    </TR>
                </TBODY>
            </TABLE>
