...
-->
<%@ page
    import="java.math.BigDecimal,org.iscas.databean.*,org.iscas.service.*,org.iscas.util.*"
...
<% 
    ...
    try{
    	QuoteBean quoteData = quoteService.getQuote(symbol,uuid);
...
<TR align="center" bgcolor="#fafcb6">
    ...
    <TD nowrap><%= quoteData.getOpen1()%></TD>
    <TD>$ <%= quoteData.getPrice()%></TD>
    <TD><%= FinancialUtils.printGainHTML(new BigDecimal(quoteData.getChange1())) %>
    <%= FinancialUtils.printGainPercentHTML( FinancialUtils.computeGainPercent(quoteData.getPrice(), quoteData.getOpen1())) %></TD>
    <TD>
