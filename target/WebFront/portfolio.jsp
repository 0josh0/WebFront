...
<%@ page import="java.util.Collection, java.util.Iterator, java.util.HashMap, java.math.BigDecimal, org.iscas.util.*,org.iscas.databean.*,org.iscas.entity.Holding" session="true" isThreadSafe="true" isErrorPage="false"%>
...
while ( it.hasNext() ) 
{
    QuoteBean quoteData = (QuoteBean) it.next();
...
try {
    while (it.hasNext()) {
        ...
        QuoteBean quoteData = (QuoteBean) quoteMap.get(holdingData.getQuoteSymbol());
        ...
        if (basis.doubleValue() == 0.0)
        {
            ...
            Log.error("portfolio.jsp: Holding with zero basis. holdingID="+holdingData.getHoldingID() + " symbol=" + holdingData.getQuoteSymbol() + " purchasePrice=" + holdingData.getPurchasePrice());
        }
        else
