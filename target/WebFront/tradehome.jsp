...
<%@ page
        import="org.iscas.databean.OrderDataBean, org.iscas.util.FinancialUtils, java.math.BigDecimal"
        session="true" isThreadSafe="true" isErrorPage="false"%>
<%@ page import="java.util.Collection" %>
<%@ page import="java.util.Iterator" %>
<jsp:useBean id="results" scope="request" type="java.lang.String" />
<jsp:useBean id="accountData"
             type="org.iscas.databean.AccountDataBean"
             scope="request" />
        ...
        <TR>
            ...
            <TD align="center" valign="top" bgcolor="#ffffff" width="236">
                <jsp:include page="marketSummary.jsp" flush="" >
                	<% String uuid=(String)request.getAttribute("uuid");   session.setAttribute("uuid",uuid); %> 
                </jsp:include> <BR>
            </TD>
        </TR>
    </TBODY>
