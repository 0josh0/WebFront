...
<%@ page import="java.util.Collection, java.util.Iterator, org.iscas.databean.*,org.iscas.util.*" session="true" isThreadSafe="true" isErrorPage="false"%>
  ...
  <TBODY>
    <TR>
        ...
        <TR align="left">
            ...
            <TD><B><A href="app?action=quotes&symbols=s:01,s:02,s:03,s:04,s:05">Quotes/Trade</A></B></TD>
        ...
        <TR>
            ...
            <TABLE width="100%">
                <TBODY>
                    ...
                    <% 
 OrderBean orderData = (OrderBean)request.getAttribute("orderData");
 if ( orderData != null )
 {
                    %>
                    <TR>
                    ...
                    <TR>
                        ...
                        Order <%=orderData.getOrderID()%></B> to <B><%=orderData.getOrderType()%> <%=orderData.getQuantity()%></B> shares of <B><%=orderData.getQuoteSymbol()%></B> has been submitted for processing. </FONT><BR>
                        <BR>
            ...
            <TABLE width="100%" style="font-size: smaller">
                <TBODY>
                    <TR>
                        ...
                        <TD align="right"><FORM><INPUT type="submit" name="action" value="quotes"> <INPUT size="20" type="text" name="symbols" value="s:01, s:02, s:03, s:04, s:05"></FORM></TD>
                    </TR>
                </TBODY>
            </TABLE>
            </TD>
